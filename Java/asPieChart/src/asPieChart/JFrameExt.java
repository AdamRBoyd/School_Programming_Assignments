...
public class JFrameExt extends JFrame {
	...
	public JFrameExt(double north, double south, double east, double west, double midwest) throws HeadlessException {
		super();
		this.north = north;
		this.south = south;
		this.east = east;
